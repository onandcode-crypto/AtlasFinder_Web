    ...
    <div className="flex flex-col w-full -mt-20">
      ...
      <section className="relative min-h-screen flex items-center bg-ivory pt-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 w-full z-10 flex flex-col items-center justify-center text-center pt-12 lg:pt-0">
          <h1 className="text-3xl sm:text-7xl lg:text-[80px] font-extrabold leading-[1.1] text-charcoal tracking-tight mb-6">
            ATLASFINDER
          </h1>
          <p className="text-base sm:text-3xl font-medium text-charcoal mb-3">
            나다운 내일을 찾아가는 항해 지도
          </p>
          <p className="text-xs sm:text-lg text-charcoal/80 mb-8 leading-relaxed max-w-xl font-medium">
